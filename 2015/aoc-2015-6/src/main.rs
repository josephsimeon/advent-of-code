...
fn process_lighting_instruction(instruction: &str) -> (LightInstruction, (u16, u16), (u16, u16)) {
    ...
    (light_instr, (numbers[0], numbers[2]), (numbers[1], numbers[3]))
}
...
mod test {
    ...
    fn test_all_lift_on() {
        ...
        assert_eq!(process_lighting_instruction(test), (LightInstruction::On, (0, 999), (0, 999)));
    }
}

static INPUT: &str = "turn on 489,959 through 759,964
